...
async def main():
    ...
    pii_tests = [
        ...
        ("openai_key", "Key: sk-abcdefghijklmnopqrstuvwxyz1234567890", "sk-abcdefghijkl"),
        ("aws_key", "AWS: AKIA1234567890ABCDEF", "AKIA1234567890ABCDEF"),
        ("github_token", "token: ghp_ABCDEFGHIJKLMNOPQRSTUVWXYZ123456", "ghp_ABCDEFGHIJ"),
        ("stripe_key", "sk_live_REDACTED", "sk_live_REDACTED"),
